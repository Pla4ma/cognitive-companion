// ══════════════════════════════════════════════════════════════
// INTENT — Phase 64: Deep Testing for New Systems
// ══════════════════════════════════════════════════════════════

import { detectPlanningLoop, generatePlanningLoopCopy } from '../engine/planningLoopDetector'
import { createOpenLoop, createLoopFromFailure, updateLoopStatus } from '../engine/openLoopEngine'
import { createAttentionReceipt, getReceiptTitle } from '../engine/attentionReceiptEngine'
import { getEmergencyStartMission, getEmergencyStartForState } from '../engine/emergencyStartEngine'
import { createIntentLockState, recordExitAttempt, shouldShowExitFriction, deactivateIntentLock } from '../engine/intentLockEngine'
import { isNewUser, getStarterDefault, processFeedback } from '../engine/newUserMagic'
import { getOutcomeMeta, isProgress, getOutcomeOptions } from '../engine/outcomeEngine'
import { calculateIntentScore, getScoreDisclaimer } from '../engine/intentScore'
import { createEmptyPlaybook, updatePlaybookFromOutcome, getPlaybookSummary } from '../engine/playbookEngine'
...
import { createMissionThread, addThreadEvent, getThreadSummary } from '../engine/missionThreadEngine'
import { generateDriftMirrorInsight } from '../engine/driftMirror'
import { generateCommandlessRecommendation } from '../engine/commandlessAgent'
import { validateAIOutput, validateMissionQuality } from '../services/ai/validatedAI'
import { generateCandidates, selectBestCandidate, explainCandidateChoice } from '../engine/missionCandidateSelector'
