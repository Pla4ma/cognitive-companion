...
export default function SettingsScreen() {
  ...
  const [coachPrompts, setCoachPrompts] = useState(true)
          ...
          <>
            ...
            <Card variant="default" style={styles.notifCard}>
              <View style={styles.notifRow}>
                ...
                <Switch value={smartAlerts} onValueChange={setSmartAlerts} trackColor={{ false: colors.border.default, true: colors.brand[500] }} />
              </View>
              <View style={styles.notifRow}>
                <Text style={styles.notifLabel}>Streak Protection</Text>
                <Switch value={weeklyDigest} onValueChange={setWeeklyDigest} trackColor={{ false: colors.border.default, true: colors.brand[500] }} />
              </View>
              <View style={styles.notifRow}>
                <Text style={styles.notifLabel}>Haptic Feedback</Text>
                <Switch value={coachPrompts} onValueChange={setCoachPrompts} trackColor={{ false: colors.border.default, true: colors.brand[500] }} />
              </View>
            </Card>
